      ...
      <div className="grid md:grid-cols-3 gap-6">
        {relatedPosts.map((post, index) => (
          <article
            ...
            className="p-6 bg-gray-900/50 backdrop-blur-sm border border-purple-500/20 rounded-xl hover:border-purple-500/50 transition-all duration-300 group flex flex-col justify-between"
          >
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">{post.subheadline}</p>
            </div>
